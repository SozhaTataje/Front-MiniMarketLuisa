...
import { FaShoppingCart, FaUserCircle, FaBars, FaTimes, FaCog, FaClipboardList, FaSignOutAlt, FaUser, FaMapMarkerAlt } from "react-icons/fa";
  ...
  return (
    <header className="bg-white shadow-md">
      <nav className="p-5 max-w-screen-xl mx-auto flex justify-between items-center relative">
        ...
        <div
          className={`absolute md:static top-20 left-0 w-full md:w-auto bg-white md:bg-transparent z-50 transition-all duration-300 shadow-md md:shadow-none rounded-b-xl ${menuOpen ? "block" : "hidden"
