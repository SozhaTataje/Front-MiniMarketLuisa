...
const EditarProductoModal = ({ isOpen, onClose, producto, categorias = [], onSuccess }) => {
  ...
  const handleChange = (e) => {
    ...
    if (type === 'file') {
      ...
      if (name === 'imagen') setImagePreview(value);
    }
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-600 focus:border-purple-600 transition-colors ${
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-600 focus:border-purple-600 transition-colors resize-none ${
            ...
            <div className="md:col-span-2">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  onChange={handleChange}
                  className="w-5 h-5 text-purple-600 border-gray-300 rounded focus:ring-purple-600 focus:ring-2"
                  disabled={loading}
                />
        ...
        <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="px-6 py-2.5 bg-purple-600 hover:bg-purple-700 text-white font-medium rounded-xl flex items-center gap-2 transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:transform-none"
            >
              {loading ? (
